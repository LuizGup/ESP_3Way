...
// --- Configurações MQTT (Apenas para o Principal) ---
  ...
  #define AIO_USERNAME    "LuizGup" // Substitua pelo seu usuário Adafruit IO
  #define AIO_KEY         "aio_ilxL72oXYXdX2QW6pRxUls6nOlEp"   // Substitua pela sua chave Adafruit IO
#endif
...
void OnDataRecv(const esp_now_recv_info_t *recvInfo, const uint8_t *incomingData, int len) {
  ...
  if (received_data.timestamp > last_seen) {
    ...
    // Dados repetidos ou antigos, ignorados silenciosamente
  }
}
